...
function RevisionRowExpandableMannWhitneyU(props: RevisionRowExpandableMannWhitneyUProps) {
  const { resultStats, id } = props;
        ...
        <Grid container spacing={2}>
          <Grid size={8}>
            <Stack spacing={2}>
              ...
              />
              <Distribution result={resultStats} />
            </Stack>
          </Grid>
          <Grid size={4}>
            <div>
...
interface RevisionRowExpandableMannWhitneyUProps {
  resultStats: CompareResultsMannWhitneyUItem;
  id: string;
}

export default RevisionRowExpandableMannWhitneyU;
